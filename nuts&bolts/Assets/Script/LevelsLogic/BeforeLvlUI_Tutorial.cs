...
public class BeforeLvlUI_Tutorial : MonoBehaviour
{
    ...
    private bool errorModalOpenP1 = false;
    private bool errorModalOpenP2 = false;

    public void OnWASD(InputAction.CallbackContext context)
    {
        if (P1ready) return;
        if (menuCanvas.activeInHierarchy) return;
        if (errorModalOpenP1) return;
    ...
    public void OnLShift(InputAction.CallbackContext context)
    {
        ...
        if (pressed)
        {
            ...
            else if (NavIdxP1.x == 5 && NavIdxP1.y == 0 && !readyModalOpenP1 && !errorModalOpenP1)
            {
            ...
            else if (errorModalOpenP1)
            {
                errorModalOpenP1 = false;
                P1_UI.Find("ModalExpl").gameObject.SetActive(false);
                audiosrc.PlayOneShot(audioClipMove);
            }
            else if (readyModalOpenP1)
            {
    ...
    public void OnRShift(InputAction.CallbackContext context)
    {
        ...
        if (pressed)
        {
            ...
            else if (NavIdxP2.x == 5 && NavIdxP2.y == 0 && !readyModalOpenP2 && !errorModalOpenP2)
            {
            ...
            else if (errorModalOpenP2)
            {
                errorModalOpenP2 = false;
                P2_UI.Find("ModalExpl").gameObject.SetActive(false);
                audiosrc.PlayOneShot(audioClipMove);
            }
            else if (readyModalOpenP2)
            {
    ...
    bool CorrectlyAssigned(int p)
    {
        if (p == 1)
        {
            if (viewP1 == 3) return true;

            errorModalOpenP1 = true;
            P1_UI.Find("ModalExpl").gameObject.SetActive(true);
            return false;
        }
        else
        {
            if (leftArmP2 == 1) return true;

            errorModalOpenP2 = true;
            P2_UI.Find("ModalExpl").gameObject.SetActive(true);
            return false;
        }
    }
